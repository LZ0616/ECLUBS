	...
	<div class="zy_content wid_main">
		<div class="zy_formbox zy_register fix">
			<div class="left">
				...
				<form id="form1" name="form1" action="ApplyNewsDoServlet?cid=${news.cid }" method="post" enctype="multipart/form-data">
					<div>
						<p><b>*</b>社团名称:	${news.cname }</p>
				
					</div>
					<div>
						<p><b>*</b>社长:${news.master }</p>
			
					</div>
					<div>
						<p><b>*</b>新闻主题</p>
						<input type="text" name="title" placeholder="请输入新闻主题">
					</div>
					<div>
						<p><b>*</b>新闻内容</p>
						<textarea name="content" placeholder="请输入新闻内容"></textarea>
					</div>
					<div>
						<p><b>*</b>时间</p>
						<input type="text" name="time" placeholder="请输入时间">
					</div>
						<p><b style="color:red">*</b>选择图片</p>
