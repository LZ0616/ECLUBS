	...
	<div class="zy_content wid_main">
		<div class="zy_formbox zy_register fix">
			<div class="left">
			    ...
			    <p align="center">退团申请</p>

	<form id="form1" name="form1" onsubmit=" return check(this)" 
				action="ApplyOutClubDoServlet?cid=${list.cid }&cname=${list.cname }" method="post">
					<div>
						<p><b>*</b>申请退出的社团：${list.cname }</p>
					</div>
					...
					<div>
						<p><b>*</b>退团理由</p>
						<textarea name="reason"  placeholder="请输入退团理由"></textarea>
					</div>
					<div class="btn">
