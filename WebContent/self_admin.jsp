...
<body>
	 ...
	 <div class="zy_formbox zy_register fix">
		...
		<a style="font-size:20px ;	
							...
							cursor: pointer;" href="ShowApplyActServlet?con=1">活动申请消息</a>
		<a style="font-size:20px ;	
							color:#333;
							background:#D3D3D3;
							margin-left:20px;
							...
							border-radius: 10px;
							border: 1px solid rgba(0,0,0,0.4) ;
							cursor: pointer;" href="ShowApplyNewsServlet?con=1">新闻发布消息</a>
		<a style="font-size:20px ;	
							color:#333;
							background:#D3D3D3;
							margin-left:20px;
							...
							border-radius: 10px;
							border: 1px solid rgba(0,0,0,0.4) ;
							cursor: pointer;" href="ShowApplyCreateClubServlet?con=1">社团创建消息</a>
		<a style="font-size:20px ;	
							color:#333;
							background:#D3D3D3;
							margin-left:20px;
							...
							border-radius: 10px;
							border: 1px solid rgba(0,0,0,0.4) ;
							cursor: pointer;" href="ListApplyDeleteClubServlet">社团解散消息</a>
							</center>
