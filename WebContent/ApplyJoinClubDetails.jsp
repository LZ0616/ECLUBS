		...
		<div class="zy_formbox zy_register fix">
			<div class="left">
				...
				<form >
					...
					<div>
						<p><b>*</b>个人简介：${list.selfintro }</p>
					</div>
					<div>
						<p><b>*</b>入团理由：${list.reason}</p>
					</div>
					</form>
					
					<div class="btn">
						<a href="JoinClubServlet?id=${list.id }&cid=${list.cid }&account=${list.account }&con=1">
						<button type="submit">同意</button>
						<a href="CheckApplyJoinClubServlet?id=${list.id }&cid=${list.cid }&account=${list.account }&con=2">
