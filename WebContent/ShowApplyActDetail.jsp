	 ...
	 <div class="xq_title">
		<h1>${act.cname }	
				<a style="font-size:20px ;	
							...
							cursor: pointer;" href="CheckActivityServlet?id=${act.id }&&con=1">同意</a>
				<a style="font-size:20px ;	
							color:#333;
							background:#D3D3D3;
							padding:5px 15px;
							border-radius: 10px;
							border: 1px solid rgba(0,0,0,0.4) ;
							cursor: pointer;" href="CheckActivityServlet?id=${act.id }&&con=2">驳回</a>
		<p><span>社长：${act.master }</span><span>活动时间：${act.time }</span></p>
		
		<p><span><a href="getApplyActPicture?id=${act.id }"target="_blank">	<img src="getApplyActPicture?id=${act.id }"/></a></span></p>
