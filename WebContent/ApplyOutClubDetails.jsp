		...
		<div class="zy_formbox zy_register fix">
			<div class="left">
				...
				<form >
					...
					<div>
						<p><b>*</b>退团理由：${list.reason}</p>
					</div>
					</form>
					
					<div class="btn">
						<a href="OutClubServlet?id=${list.id }&cid=${list.cid }&account=${list.account }&con=1">
						<button type="submit">同意</button>
						<a href="CheckApplyOutClubServlet?id=${list.id }&cid=${list.cid }&account=${list.account }&con=2">
