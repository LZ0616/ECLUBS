...
<body>
	 ...
	 <li class="cur"><a href="NewsListServlet">大事件</a>
	...
	<c:forEach items="${list }" var="news">
		<li>
		   <a href="ApplyNewsDetailServlet?id=${news.id}">
		   <i><img src="getApplyNewsPicture?id=${news.id }"></i>
		 
		   <div>
		   <h2 >新闻标题：${news.title }</h2>
		   <p></p>
		   <span>发布社团：${news.cname }</span>
		   </div></a>
		 </li>
		 </c:forEach>
	 </ul>		
