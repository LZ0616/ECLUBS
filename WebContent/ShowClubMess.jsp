...
<body>
	...
	<div class="pic"><img src="images/zx.png"></div>
     ...
     <div>
     <div>
         <h3 align="center" style="color: blue;font-size:20px;">反馈信息</h3>
     </div>
     </div>
     </div>
    ...
    <c:forEach items="${list }" var="anb"> 
	 <tr>
		<td style="font-size:15px;">${anb.content }</td>
		<td><a href="CheckResponseActNewsServlet?cid=${anb.cid }&&flag=${anb.flag}">确认</a></td>
