...
/**
 * Servlet implementation class GetApplyActPictureServlet
 */
@WebServlet("/GetApplyActPictureServlet")
public class GetApplyActPictureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetApplyActPictureServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt=myconn.prepareStatement("SELECT filename,img FROM check_act WHERE id=?");
			stmt.setString(1, id);
