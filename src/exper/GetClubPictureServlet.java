...
/**
 * Servlet implementation class GetClubPictureServlet
 */
@WebServlet("/GetClubPictureServlet")
public class GetClubPictureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetClubPictureServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt=myconn.prepareStatement("SELECT filename,img FROM club_info WHERE id=?");
			stmt.setString(1, id);
