...
/**
 * Servlet implementation class GetApplyNewsPictureServlet
 */
@WebServlet("/GetApplyNewsPictureServlet")
public class GetApplyNewsPictureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetApplyNewsPictureServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt=myconn.prepareStatement("SELECT filename,img FROM check_news WHERE id=?");
			stmt.setString(1, id);
