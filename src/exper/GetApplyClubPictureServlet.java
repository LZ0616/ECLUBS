...
/**
 * Servlet implementation class GetApplyClubPictureServlet
 */
@WebServlet("/GetApplyClubPictureServlet")
public class GetApplyClubPictureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetApplyClubPictureServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt=myconn.prepareStatement("SELECT filename,img FROM check_creclub WHERE id=?");
			stmt.setString(1, id);
