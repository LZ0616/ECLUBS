...
/**
 * Servlet implementation class GetNewsPictureServlet
 */
@WebServlet("/GetNewsPictureServlet")
public class GetNewsPictureServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetNewsPictureServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt=myconn.prepareStatement("SELECT filename,img FROM club_news WHERE id=?");
			stmt.setString(1, id);
