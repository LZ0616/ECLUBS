...
/**
 * Servlet implementation class ApplyDeleteClubDetailsServlet
 */
@WebServlet("/ApplyDeleteClubDetailsServlet")
public class ApplyDeleteClubDetailsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApplyDeleteClubDetailsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {	
			...
			String sql = "select * from check_delclub where id = "+id;			
		...
		//if(status.equals("admin")){
			...
			request.getRequestDispatcher("ApplyDeleteClubDetails.jsp").forward(request, response);
		//}
